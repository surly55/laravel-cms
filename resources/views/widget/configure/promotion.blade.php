  ...
  <div class="form-group">
    ...
    <div class="row all-images">
      <div class="col-md-12" id="widget-images-div-0" >
        ...
        <br>
        <label>HTML</label>
        <input type="text" name="images[html][]" value="" class="form-control" placeholder="Html" />
        <br>
        <label>Path</label>
        <input type="text" name="images[path][]" value="" class="form-control" placeholder="Html" />
        <br>
        <label>Button</label>
        <input type="text" name="images[button][]" value="" class="form-control" placeholder="Html" />
        <br>
