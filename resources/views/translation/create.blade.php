...
@section('content')
    {!! Form::open([ 'route' => 'translation.store', 'class' => 'form', 'role' => 'form' ]) !!}
    <section class="content-header">
        <h1><i class="fa fa-plus"></i>Create translation <div class="action-buttons"><button class="btn btn-primary" type="submit"><i class="fa fa-file"></i>Save</button></div></h1>
        <ol class="breadcrumb">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="box box-solid box-primary">
                    ...
                    <div class="box-body">@include('translation._form', [ 'action' => 'create' ])</div>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="box box-default">
                    ...
                    <div class="box-body">@include('translation._form-translations', [ 'action' => 'create' ])</div>
                </div>
            </div>
        </div>
    </section>
